...
import { ChatPhotoComponent } from 'app/entities/chat-photo/chat-photo.component';
...
describe('Component Tests', () => {
  describe('ChatPhoto Management Component', () => {
    let comp: ChatPhotoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChatPhotoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chatPhotos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
