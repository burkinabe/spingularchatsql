...
import com.spingular.spingularchatsql.repository.ChatRoomAllowedUserRepository;
import com.spingular.spingularchatsql.service.ChatRoomAllowedUserService;
import com.spingular.spingularchatsql.service.dto.ChatRoomAllowedUserDTO;
import com.spingular.spingularchatsql.service.mapper.ChatRoomAllowedUserMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatRoomAllowedUserCriteria;
import com.spingular.spingularchatsql.service.ChatRoomAllowedUserQueryService;
...
public class ChatRoomAllowedUserResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatRoomAllowedUsersByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomAllowedUserRepository.saveAndFlush(chatRoomAllowedUser);

        // Get all the chatRoomAllowedUserList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatRoomAllowedUserShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatRoomAllowedUserList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatRoomAllowedUserShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatRoomAllowedUsersByBannedUserIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomAllowedUserRepository.saveAndFlush(chatRoomAllowedUser);

        // Get all the chatRoomAllowedUserList where bannedUser not equals to DEFAULT_BANNED_USER
        defaultChatRoomAllowedUserShouldNotBeFound("bannedUser.notEquals=" + DEFAULT_BANNED_USER);

        // Get all the chatRoomAllowedUserList where bannedUser not equals to UPDATED_BANNED_USER
        defaultChatRoomAllowedUserShouldBeFound("bannedUser.notEquals=" + UPDATED_BANNED_USER);
    }
    ...
    @Test
    @Transactional
    public void getAllChatRoomAllowedUsersByBannedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomAllowedUserRepository.saveAndFlush(chatRoomAllowedUser);

        // Get all the chatRoomAllowedUserList where bannedDate not equals to DEFAULT_BANNED_DATE
        defaultChatRoomAllowedUserShouldNotBeFound("bannedDate.notEquals=" + DEFAULT_BANNED_DATE);

        // Get all the chatRoomAllowedUserList where bannedDate not equals to UPDATED_BANNED_DATE
        defaultChatRoomAllowedUserShouldBeFound("bannedDate.notEquals=" + UPDATED_BANNED_DATE);
    }
