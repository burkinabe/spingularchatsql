...
import com.spingular.spingularchatsql.repository.ChatOffensiveMessageRepository;
import com.spingular.spingularchatsql.service.ChatOffensiveMessageService;
import com.spingular.spingularchatsql.service.dto.ChatOffensiveMessageDTO;
import com.spingular.spingularchatsql.service.mapper.ChatOffensiveMessageMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatOffensiveMessageCriteria;
import com.spingular.spingularchatsql.service.ChatOffensiveMessageQueryService;
...
public class ChatOffensiveMessageResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatOffensiveMessagesByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatOffensiveMessageRepository.saveAndFlush(chatOffensiveMessage);

        // Get all the chatOffensiveMessageList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatOffensiveMessageShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatOffensiveMessageList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatOffensiveMessageShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatOffensiveMessagesByIsOffensiveIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatOffensiveMessageRepository.saveAndFlush(chatOffensiveMessage);

        // Get all the chatOffensiveMessageList where isOffensive not equals to DEFAULT_IS_OFFENSIVE
        defaultChatOffensiveMessageShouldNotBeFound("isOffensive.notEquals=" + DEFAULT_IS_OFFENSIVE);

        // Get all the chatOffensiveMessageList where isOffensive not equals to UPDATED_IS_OFFENSIVE
        defaultChatOffensiveMessageShouldBeFound("isOffensive.notEquals=" + UPDATED_IS_OFFENSIVE);
    }
