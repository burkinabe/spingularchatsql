...
import com.spingular.spingularchatsql.repository.ChatNotificationRepository;
import com.spingular.spingularchatsql.service.ChatNotificationService;
import com.spingular.spingularchatsql.service.dto.ChatNotificationDTO;
import com.spingular.spingularchatsql.service.mapper.ChatNotificationMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatNotificationCriteria;
import com.spingular.spingularchatsql.service.ChatNotificationQueryService;
...
import com.spingular.spingularchatsql.domain.enumeration.ChatNotificationReason;
/**
...
public class ChatNotificationResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatNotificationsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatNotificationRepository.saveAndFlush(chatNotification);

        // Get all the chatNotificationList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatNotificationShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatNotificationList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatNotificationShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatNotificationsByChatNotificationReasonIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatNotificationRepository.saveAndFlush(chatNotification);

        // Get all the chatNotificationList where chatNotificationReason not equals to DEFAULT_CHAT_NOTIFICATION_REASON
        defaultChatNotificationShouldNotBeFound("chatNotificationReason.notEquals=" + DEFAULT_CHAT_NOTIFICATION_REASON);

        // Get all the chatNotificationList where chatNotificationReason not equals to UPDATED_CHAT_NOTIFICATION_REASON
        defaultChatNotificationShouldBeFound("chatNotificationReason.notEquals=" + UPDATED_CHAT_NOTIFICATION_REASON);
    }
