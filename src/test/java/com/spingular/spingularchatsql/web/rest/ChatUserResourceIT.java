...
import com.spingular.spingularchatsql.domain.User;
...
import com.spingular.spingularchatsql.repository.ChatUserRepository;
import com.spingular.spingularchatsql.service.ChatUserService;
import com.spingular.spingularchatsql.service.dto.ChatUserDTO;
import com.spingular.spingularchatsql.service.mapper.ChatUserMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatUserCriteria;
import com.spingular.spingularchatsql.service.ChatUserQueryService;
...
public class ChatUserResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatUsersByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatUserRepository.saveAndFlush(chatUser);

        // Get all the chatUserList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatUserShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatUserList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatUserShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatUsersByBannedUserIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatUserRepository.saveAndFlush(chatUser);

        // Get all the chatUserList where bannedUser not equals to DEFAULT_BANNED_USER
        defaultChatUserShouldNotBeFound("bannedUser.notEquals=" + DEFAULT_BANNED_USER);

        // Get all the chatUserList where bannedUser not equals to UPDATED_BANNED_USER
        defaultChatUserShouldBeFound("bannedUser.notEquals=" + UPDATED_BANNED_USER);
    }
