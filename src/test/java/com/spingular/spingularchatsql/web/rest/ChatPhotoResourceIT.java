...
import com.spingular.spingularchatsql.repository.ChatPhotoRepository;
import com.spingular.spingularchatsql.service.ChatPhotoService;
import com.spingular.spingularchatsql.service.dto.ChatPhotoDTO;
import com.spingular.spingularchatsql.service.mapper.ChatPhotoMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatPhotoCriteria;
import com.spingular.spingularchatsql.service.ChatPhotoQueryService;
...
public class ChatPhotoResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatPhotosByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatPhotoRepository.saveAndFlush(chatPhoto);

        // Get all the chatPhotoList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatPhotoShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatPhotoList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatPhotoShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
