...
import com.spingular.spingularchatsql.repository.ChatRoomRepository;
import com.spingular.spingularchatsql.service.ChatRoomService;
import com.spingular.spingularchatsql.service.dto.ChatRoomDTO;
import com.spingular.spingularchatsql.service.mapper.ChatRoomMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatRoomCriteria;
import com.spingular.spingularchatsql.service.ChatRoomQueryService;
...
public class ChatRoomResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatRoomsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatRoomShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatRoomList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatRoomShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatRoomsByRoomNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where roomName not equals to DEFAULT_ROOM_NAME
        defaultChatRoomShouldNotBeFound("roomName.notEquals=" + DEFAULT_ROOM_NAME);

        // Get all the chatRoomList where roomName not equals to UPDATED_ROOM_NAME
        defaultChatRoomShouldBeFound("roomName.notEquals=" + UPDATED_ROOM_NAME);
    }
    ...
    public void getAllChatRoomsByRoomNameIsNullOrNotNull() throws Exception {
        ...
        defaultChatRoomShouldNotBeFound("roomName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllChatRoomsByRoomNameContainsSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where roomName contains DEFAULT_ROOM_NAME
        defaultChatRoomShouldBeFound("roomName.contains=" + DEFAULT_ROOM_NAME);

        // Get all the chatRoomList where roomName contains UPDATED_ROOM_NAME
        defaultChatRoomShouldNotBeFound("roomName.contains=" + UPDATED_ROOM_NAME);
    }

    @Test
    @Transactional
    public void getAllChatRoomsByRoomNameNotContainsSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where roomName does not contain DEFAULT_ROOM_NAME
        defaultChatRoomShouldNotBeFound("roomName.doesNotContain=" + DEFAULT_ROOM_NAME);

        // Get all the chatRoomList where roomName does not contain UPDATED_ROOM_NAME
        defaultChatRoomShouldBeFound("roomName.doesNotContain=" + UPDATED_ROOM_NAME);
    }
    ...
    @Test
    @Transactional
    public void getAllChatRoomsByRoomDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where roomDescription not equals to DEFAULT_ROOM_DESCRIPTION
        defaultChatRoomShouldNotBeFound("roomDescription.notEquals=" + DEFAULT_ROOM_DESCRIPTION);

        // Get all the chatRoomList where roomDescription not equals to UPDATED_ROOM_DESCRIPTION
        defaultChatRoomShouldBeFound("roomDescription.notEquals=" + UPDATED_ROOM_DESCRIPTION);
    }
    ...
    public void getAllChatRoomsByRoomDescriptionIsNullOrNotNull() throws Exception {
        ...
        defaultChatRoomShouldNotBeFound("roomDescription.specified=false");
                ...
                @Test
    @Transactional
    public void getAllChatRoomsByRoomDescriptionContainsSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where roomDescription contains DEFAULT_ROOM_DESCRIPTION
        defaultChatRoomShouldBeFound("roomDescription.contains=" + DEFAULT_ROOM_DESCRIPTION);

        // Get all the chatRoomList where roomDescription contains UPDATED_ROOM_DESCRIPTION
        defaultChatRoomShouldNotBeFound("roomDescription.contains=" + UPDATED_ROOM_DESCRIPTION);
    }

    @Test
    @Transactional
    public void getAllChatRoomsByRoomDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where roomDescription does not contain DEFAULT_ROOM_DESCRIPTION
        defaultChatRoomShouldNotBeFound("roomDescription.doesNotContain=" + DEFAULT_ROOM_DESCRIPTION);

        // Get all the chatRoomList where roomDescription does not contain UPDATED_ROOM_DESCRIPTION
        defaultChatRoomShouldBeFound("roomDescription.doesNotContain=" + UPDATED_ROOM_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    public void getAllChatRoomsByPrivateRoomIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatRoomRepository.saveAndFlush(chatRoom);

        // Get all the chatRoomList where privateRoom not equals to DEFAULT_PRIVATE_ROOM
        defaultChatRoomShouldNotBeFound("privateRoom.notEquals=" + DEFAULT_PRIVATE_ROOM);

        // Get all the chatRoomList where privateRoom not equals to UPDATED_PRIVATE_ROOM
        defaultChatRoomShouldBeFound("privateRoom.notEquals=" + UPDATED_PRIVATE_ROOM);
    }
