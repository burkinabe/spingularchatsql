...
import com.spingular.spingularchatsql.repository.ChatInvitationRepository;
import com.spingular.spingularchatsql.service.ChatInvitationService;
import com.spingular.spingularchatsql.service.dto.ChatInvitationDTO;
import com.spingular.spingularchatsql.service.mapper.ChatInvitationMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatInvitationCriteria;
import com.spingular.spingularchatsql.service.ChatInvitationQueryService;
...
public class ChatInvitationResourceIT {
    ...
    @Test
    @Transactional
    public void getAllChatInvitationsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatInvitationRepository.saveAndFlush(chatInvitation);

        // Get all the chatInvitationList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultChatInvitationShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the chatInvitationList where creationDate not equals to UPDATED_CREATION_DATE
        defaultChatInvitationShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatInvitationsByAcceptanceIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatInvitationRepository.saveAndFlush(chatInvitation);

        // Get all the chatInvitationList where acceptance not equals to DEFAULT_ACCEPTANCE
        defaultChatInvitationShouldNotBeFound("acceptance.notEquals=" + DEFAULT_ACCEPTANCE);

        // Get all the chatInvitationList where acceptance not equals to UPDATED_ACCEPTANCE
        defaultChatInvitationShouldBeFound("acceptance.notEquals=" + UPDATED_ACCEPTANCE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatInvitationsByDenialIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatInvitationRepository.saveAndFlush(chatInvitation);

        // Get all the chatInvitationList where denial not equals to DEFAULT_DENIAL
        defaultChatInvitationShouldNotBeFound("denial.notEquals=" + DEFAULT_DENIAL);

        // Get all the chatInvitationList where denial not equals to UPDATED_DENIAL
        defaultChatInvitationShouldBeFound("denial.notEquals=" + UPDATED_DENIAL);
    }
    ...
    @Test
    @Transactional
    public void getAllChatInvitationsByAcceptanceDenialDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatInvitationRepository.saveAndFlush(chatInvitation);

        // Get all the chatInvitationList where acceptanceDenialDate not equals to DEFAULT_ACCEPTANCE_DENIAL_DATE
        defaultChatInvitationShouldNotBeFound("acceptanceDenialDate.notEquals=" + DEFAULT_ACCEPTANCE_DENIAL_DATE);

        // Get all the chatInvitationList where acceptanceDenialDate not equals to UPDATED_ACCEPTANCE_DENIAL_DATE
        defaultChatInvitationShouldBeFound("acceptanceDenialDate.notEquals=" + UPDATED_ACCEPTANCE_DENIAL_DATE);
    }
