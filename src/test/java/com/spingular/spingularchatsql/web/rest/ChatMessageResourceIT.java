package com.spingular.spingularchatsql.web.rest;

import com.spingular.spingularchatsql.SpingularchatsqlApp;
import com.spingular.spingularchatsql.domain.ChatMessage;
import com.spingular.spingularchatsql.domain.ChatNotification;
...
import com.spingular.spingularchatsql.repository.ChatMessageRepository;
import com.spingular.spingularchatsql.service.ChatMessageService;
import com.spingular.spingularchatsql.service.dto.ChatMessageDTO;
import com.spingular.spingularchatsql.service.mapper.ChatMessageMapper;
import com.spingular.spingularchatsql.web.rest.errors.ExceptionTranslator;
import com.spingular.spingularchatsql.service.dto.ChatMessageCriteria;
import com.spingular.spingularchatsql.service.ChatMessageQueryService;
...
import static com.spingular.spingularchatsql.web.rest.TestUtil.createFormattingConversionService;
...
public class ChatMessageResourceIT {
    ...
    public void getChatMessage() throws Exception {
        ...
        restChatMessageMockMvc.perform(get("/api/chat-messages/{id}", chatMessage.getId()))
            ...
            .andExpect(jsonPath("$.messageSentAt").value(DEFAULT_MESSAGE_SENT_AT))
    ...
    @Test
    @Transactional
    public void getAllChatMessagesByMessageSentAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where messageSentAt not equals to DEFAULT_MESSAGE_SENT_AT
        defaultChatMessageShouldNotBeFound("messageSentAt.notEquals=" + DEFAULT_MESSAGE_SENT_AT);

        // Get all the chatMessageList where messageSentAt not equals to UPDATED_MESSAGE_SENT_AT
        defaultChatMessageShouldBeFound("messageSentAt.notEquals=" + UPDATED_MESSAGE_SENT_AT);
    }
    ...
    public void getAllChatMessagesByMessageSentAtIsNullOrNotNull() throws Exception {
        ...
        defaultChatMessageShouldNotBeFound("messageSentAt.specified=false");
                ...
                @Test
    @Transactional
    public void getAllChatMessagesByMessageSentAtContainsSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where messageSentAt contains DEFAULT_MESSAGE_SENT_AT
        defaultChatMessageShouldBeFound("messageSentAt.contains=" + DEFAULT_MESSAGE_SENT_AT);

        // Get all the chatMessageList where messageSentAt contains UPDATED_MESSAGE_SENT_AT
        defaultChatMessageShouldNotBeFound("messageSentAt.contains=" + UPDATED_MESSAGE_SENT_AT);
    }

    @Test
    @Transactional
    public void getAllChatMessagesByMessageSentAtNotContainsSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where messageSentAt does not contain DEFAULT_MESSAGE_SENT_AT
        defaultChatMessageShouldNotBeFound("messageSentAt.doesNotContain=" + DEFAULT_MESSAGE_SENT_AT);

        // Get all the chatMessageList where messageSentAt does not contain UPDATED_MESSAGE_SENT_AT
        defaultChatMessageShouldBeFound("messageSentAt.doesNotContain=" + UPDATED_MESSAGE_SENT_AT);
    }
    ...
    @Test
    @Transactional
    public void getAllChatMessagesByMessageIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where message not equals to DEFAULT_MESSAGE
        defaultChatMessageShouldNotBeFound("message.notEquals=" + DEFAULT_MESSAGE);

        // Get all the chatMessageList where message not equals to UPDATED_MESSAGE
        defaultChatMessageShouldBeFound("message.notEquals=" + UPDATED_MESSAGE);
    }
    ...
    public void getAllChatMessagesByMessageIsNullOrNotNull() throws Exception {
        ...
        defaultChatMessageShouldNotBeFound("message.specified=false");
                ...
                @Test
    @Transactional
    public void getAllChatMessagesByMessageContainsSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where message contains DEFAULT_MESSAGE
        defaultChatMessageShouldBeFound("message.contains=" + DEFAULT_MESSAGE);

        // Get all the chatMessageList where message contains UPDATED_MESSAGE
        defaultChatMessageShouldNotBeFound("message.contains=" + UPDATED_MESSAGE);
    }

    @Test
    @Transactional
    public void getAllChatMessagesByMessageNotContainsSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where message does not contain DEFAULT_MESSAGE
        defaultChatMessageShouldNotBeFound("message.doesNotContain=" + DEFAULT_MESSAGE);

        // Get all the chatMessageList where message does not contain UPDATED_MESSAGE
        defaultChatMessageShouldBeFound("message.doesNotContain=" + UPDATED_MESSAGE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatMessagesByIsReceivedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where isReceived not equals to DEFAULT_IS_RECEIVED
        defaultChatMessageShouldNotBeFound("isReceived.notEquals=" + DEFAULT_IS_RECEIVED);

        // Get all the chatMessageList where isReceived not equals to UPDATED_IS_RECEIVED
        defaultChatMessageShouldBeFound("isReceived.notEquals=" + UPDATED_IS_RECEIVED);
    }
    ...
    @Test
    @Transactional
    public void getAllChatMessagesByIsDeliveredIsNotEqualToSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where isDelivered not equals to DEFAULT_IS_DELIVERED
        defaultChatMessageShouldNotBeFound("isDelivered.notEquals=" + DEFAULT_IS_DELIVERED);

        // Get all the chatMessageList where isDelivered not equals to UPDATED_IS_DELIVERED
        defaultChatMessageShouldBeFound("isDelivered.notEquals=" + UPDATED_IS_DELIVERED);
    }
